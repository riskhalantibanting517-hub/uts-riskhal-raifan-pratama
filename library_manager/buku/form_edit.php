...
$idedit = $_GET['id_buku'];
$qry = "SELECT * FROM library_manager WHERE id='$idedit'";
                    ...
                    <div class="card-body">
                        <form action="proses_edit.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?=$data['tahun_terbit']?>" name="tahun_terbit" type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">KATEGORI</label>
                                <input value="<?=$data['kategori']?>" name="kategori" type="date" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                            </div>
